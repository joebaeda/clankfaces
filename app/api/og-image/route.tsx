    ...
    return new ImageResponse(
      ...
      >
        <div style={{
          ...
          display: 'flex', // ✅ Required for ImageResponse
          justifyContent: 'center',
          alignItems: 'center',
        }}>
          <img
            src={pfp || 'https://clankfaces.com/icon.png'}
            style={{
              width: '100%',
              height: '100%',
              objectFit: 'cover', // Forces 1:1 ratio
            }}
          />
        </div>
        <div style={{
          ...
          <img
            src={imageUri.replace("ipfs://", "https://ipfs.io/ipfs/") || 'https://clankfaces.com/icon.png'}
            style={{
              width: '100%',
              height: '100%',
              objectFit: 'cover', // Forces 1:1 ratio
